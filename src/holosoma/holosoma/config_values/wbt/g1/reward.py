...
g1_29dof_wbt_reward = RewardManagerCfg(
    terms={
        ...
        # 2026-08-05, ported from RoboNaldo (arXiv:2606.11092)'s motion_feet_lin_vel -- the 7th
        # motion-tracking term, previously missing entirely (see ROBONALDO_PORT_SCOPE.md Sec 3a).
        # weight/sigma match RoboNaldo's own S1/S2a/S2b value exactly (weight=1.0*motion_weight,
        # std=1.0, in every one of those stages -- never relaxed, unlike the root/anchor terms).
        "motion_global_feet_lin_vel": RewardTermCfg(
            func="holosoma.managers.reward.terms.wbt:motion_global_feet_lin_vel",
            params={"sigma": 1.0, "body_names": ["left_ankle_roll_link", "right_ankle_roll_link"]},
            weight=1.0,
        ),
