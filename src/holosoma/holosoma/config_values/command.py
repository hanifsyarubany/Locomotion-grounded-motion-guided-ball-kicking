...
from holosoma.config_values.unified.g1.command import g1_29dof_unified_command
...
DEFAULTS = {
    ...
    "g1_29dof_ball_kick": g1_29dof_ball_kick_command,
    "g1_29dof_unified": g1_29dof_unified_command,
}
