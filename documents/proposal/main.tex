...
\begin{document}
\title{Skills on Top of Locomotion: A Unified Humanoid Policy for Free Locomotion Control and $N$ Motion-Guided Kicking Skills}
\author{[Author Name]}
\date{August 2026}
\maketitle
...
Table~\ref{tab:capabilities} summarises these gaps across the humanoid soccer literature. Excluding Haarnoja et al.'s miniature precedent, no full-size system demonstrates omnidirectional locomotion, accurate off-axis strike targeting, or a genuine two-way handoff between locomotion and a kicking skill -- RoboNaldo's own reported degradation at extreme lateral targets and its scripted, non-learned return from a kick are representative of the field, not an outlier. These are the axes our architecture is designed to occupy.
...
\toprule
& & \multicolumn{2}{c}{\textbf{Locomotion substrate}} & \multicolumn{4}{c}{\textbf{Skill repertoire \& transitions}} \\
\cmidrule(lr){3-4}\cmidrule(lr){5-8}
Method & Platform & Free & Omni & Multi & Lateral & Loco$\to$ & Kick$\to$ \\
 & & cmd. & dir. & skill & tgt. & Kick & Loco \\
\midrule
Haarnoja et al.~\citep{haarnoja2024soccer} & Miniature & \yes & \partialmark & \yes & \partialmark & \yes & \yes \\
...
\midrule
\textbf{Ours (proposed)}       & Humanoid & \yes & \yes & \yes & \yes & \yes & \yes \\
\bottomrule
\end{tabular}
...
\begin{itemize}
  ...
  \item IROS 2027 (submission approx.\ March 2027) --- fallback with additional hardware time.
  \item CoRL 2027 --- alternative if the emphasis shifts toward the skill-composition formalism.
\end{itemize}
