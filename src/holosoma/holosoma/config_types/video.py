...
class VideoConfig:
    ...
    """wandb media key this recorder's videos are logged under. Give each simultaneously-active
    recorder (see BaseSimulator.add_video_recorder) a distinct key, or later videos will overwrite
    earlier ones in the same wandb media slot instead of appearing as separate entries."""
