...
# Unified locomotion + ball-kicking: single policy, both skills. No dual-mode
# safety secondary for v1 (kept simple per the deployment request this was built
# for) — plain robot.g1_29dof (no stiff_startup pose needed; the policy starts in
# plain locomotion mode, same startup path as g1_29dof_loco).
g1_29dof_unified_loco_kick = InferenceConfig(
    robot=robot.g1_29dof,
    observation=observation.unified_g1_29dof,
    task=task.unified,
    secondary=None,
)
...
DEFAULTS = {
    ...
    "g1-29dof-unified-loco-kick": g1_29dof_unified_loco_kick,
}
